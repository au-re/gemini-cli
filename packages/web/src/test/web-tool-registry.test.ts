...
// Mock the core package partially; keep real exports but provide minimal
// replacements for the classes used directly in this test to avoid heavy deps.
vi.mock('@google/gemini-cli-core', async (importOriginal) => {
  ...
  class MockBaseDeclarativeTool {
    ...
    // Subclasses provide logic
  }
  class MockBaseToolInvocation {
  ...
  return {
    ...
    BaseDeclarativeTool: MockBaseDeclarativeTool,
    BaseToolInvocation: MockBaseToolInvocation,
